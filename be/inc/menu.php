...
$_burgerActive = false;
foreach ($_visibleCategories as $cat) {
    foreach ($cat['items'] as [$i,$l,$href]) {
        if (_wcr_menu_active($href, $_currentScript, $_currentQuery)) { $_burgerActive = true; break 2; }
    }
}
  ...
  <div class="tile-panel" id="tile-panel">
    ...
    <div class="tile-scroll">
      ...
      <div class="tile-category">
        ...
        <div class="tile-grid">
          <?php foreach ($cat['items'] as [$icon, $label, $href, $perm, $colors]):
            [$bg, $fg] = $colors;
            $active = _wcr_menu_active($href, $_currentScript, $_currentQuery);
          ?>
