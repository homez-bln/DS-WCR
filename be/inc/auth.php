...
// ─────────────────────────────────────────────────────────────────────
// Zentrale API-Konfiguration für Rechte-Matrix / DS-Optionen
// ─────────────────────────────────────────────────────────────────────
// WICHTIG:
// Die Permissions-Checks laufen auf nahezu allen Backend-Seiten sehr früh
// (wcr_can() / wcr_require()). Deshalb müssen die API-Konstanten hier
// zentral verfügbar sein und dürfen nicht nur lokal in permissions.php oder
// ds-settings.php definiert werden.
...
function wcr_verify_csrf(bool $autoFail = true): bool {
    ...
    // WICHTIG:
    // Das Token bleibt für die gesamte Session stabil.
    // Die bisherige Rotation nach JEDEM erfolgreichen Request erzeugt Race-Conditions,
    // sobald mehrere Fetch-Requests fast gleichzeitig gesendet werden.
    // Dann validiert Request A das alte Token, rotiert es sofort,
    // und Request B/C laufen direkt danach mit einem inzwischen ungültigen Token auf 403.
    // Im Frontend äußert sich das als JSON-Parse-Fehler oder zufällige Speicherfehler.
