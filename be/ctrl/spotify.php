<?php
/**
 * ctrl/spotify.php — Spotify Controller v1
 * 3 Tabs: Playlists | Song hinzufügen | Verbindung
 * Nur admin + cernal
 */
...
<div class="sp-notice">
  ...
  <div class="sp-notice-text">
    ...
    Bitte zuerst im Tab <em>Verbindung</em> einrichten.
  </div>
</div>
<?php endif; ?>
...
(async function init(){
    ...
    // Aktuellen Track alle 30s aktualisieren
