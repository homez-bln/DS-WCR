...
<?php if ($_canCreate): ?>
<!-- ── FAB ── -->
<button id="fab-new-item" onclick="niOpen()" title="Neues Gericht anlegen">＋</button>
...
<div id="new-item-modal" role="dialog" aria-modal="true" aria-labelledby="ni-heading">
  <div class="ni-header">
    <div class="ni-title"><span class="ni-icon">🍔</span><span id="ni-heading">Neues Gericht</span></div>
  ...
  <form class="ni-body" id="ni-form" onsubmit="niSubmit(event)" novalidate>
    ...
    <div class="ni-row2">
      <div class="ni-field">
        ...
        <input type="text" id="ni-menge" name="menge" autocomplete="off" placeholder="z.B. Portion">
      </div>
      <div class="ni-field">
    ...
    <div class="ni-field">
      ...
      <input type="text" id="ni-typ" name="typ" autocomplete="off"
             list="ni-typ-list" placeholder="z.B. Snacks, Hauptspeisen …">
...
<script>const TABLE = 'food';</script>
