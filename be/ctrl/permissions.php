    ...
    'content' => [
        ...
        'items' => [
            ...
            [
                ...
                'desc'       => 'Media-Bibliothek verwalten',
                'pages'      => ['media.php'],
  ...
  <div class="ac-grid">
    <div class="ac-item ac-ok">
      ...
      <div>
        ...
        <p>wcr_can() und wcr_require() arbeiten mit der zentral geladenen Rechte-Matrix aus inc/auth.php. Änderungen hier wirken direkt auf die echten Zugriffsprüfungen.</p>
      </div>
    </div>
    <div class="ac-item ac-ok">
      <span class="ac-icon">✅</span>
